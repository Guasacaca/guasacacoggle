...
/** @constructor */
function $c_Lpoggle_LettersUtil$() {
  $c_O.call(this)
}
$c_Lpoggle_LettersUtil$.prototype = new $h_O();
$c_Lpoggle_LettersUtil$.prototype.constructor = $c_Lpoggle_LettersUtil$;
/** @constructor */
function $h_Lpoggle_LettersUtil$() {
  /*<skip>*/
}
$h_Lpoggle_LettersUtil$.prototype = $c_Lpoggle_LettersUtil$.prototype;
$c_Lpoggle_LettersUtil$.prototype.init___ = (function() {
  return this
});
$c_Lpoggle_LettersUtil$.prototype.getLettersDistribution__Llanguage_Language__sc_Seq = (function(language) {
  var x = $m_Llanguage_Spanish$();
  if ((x === language)) {
    return $as_Llanguage_Spanish$(language).distribution$1
  } else {
    throw new $c_jl_IllegalArgumentException().init___T(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["language.Language named ", " not supported"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([language])))
  }
});
$c_Lpoggle_LettersUtil$.prototype.distributedRandom__s_util_Random__D__sc_Seq__O = (function(r, total, listDistributions) {
  var n = $doubleToInt((100 * total));
  var randomNr = r.self$1.nextInt__I__I(n);
  var jsx$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(f$2) {
      var f = $as_Lpoggle_LettersUtil$ItemFreq(f$2);
      return $doubleToInt((100 * f.frequency$1))
    })
  })(this));
  var this$1 = $m_sc_Seq$();
  var jsx$1 = $as_sc_IterableLike(listDistributions.map__F1__scg_CanBuildFrom__O(jsx$2, this$1.ReusableCBFInstance$2));
  var this$2 = $m_sc_Seq$();
  return $as_Lpoggle_LettersUtil$ItemFreq(listDistributions.apply__I__O(this.findLimit__D__sc_Seq__I(randomNr, $as_sc_Seq(jsx$1.zipWithIndex__scg_CanBuildFrom__O(this$2.ReusableCBFInstance$2))))).item$1
});
$c_Lpoggle_LettersUtil$.prototype.findLimit__D__sc_Seq__I = (function(nr, sortedList) {
  _findLimit: while (true) {
    var rc12 = false;
    var x2 = null;
    var x1 = sortedList;
    var x$2 = $m_sci_Nil$();
    ...
    if ($is_sci_$colon$colon(x1)) {
      ...
      var h = $as_T2(x2.head$5);
      var p3 = x2.tl$5;
      var x$4 = $m_sci_Nil$();
      if (x$4.equals__O__Z(p3)) {
        return h.$$und2$mcI$sp__I()
      }
    };
    if (rc12) {
      var h1 = $as_T2(x2.head$5);
      var p5 = x2.tl$5;
      if ($is_sci_$colon$colon(p5)) {
        var x6 = $as_sci_$colon$colon(p5);
        var h2 = $as_T2(x6.head$5);
        var p7 = x6.tl$5;
        var x$6 = $m_sci_Nil$();
        if (x$6.equals__O__Z(p7)) {
          return ((nr <= h1.$$und1$mcI$sp__I()) ? h1.$$und2$mcI$sp__I() : h2.$$und2$mcI$sp__I())
        }
      }
    };
    var halflistIdx = ((x1.length__I() / 2) | 0);
    var x1$2 = $as_T2(x1.apply__I__O(halflistIdx));
    if ((x1$2 === null)) {
      throw new $c_s_MatchError().init___O(x1$2)
    };
    var halfValue = x1$2.$$und1$mcI$sp__I();
    var idx = x1$2.$$und2$mcI$sp__I();
    if ((nr === halfValue)) {
      return idx
    } else if ((nr < halfValue)) {
      sortedList = $as_sc_Seq(x1.splitAt__I__T2(halflistIdx).$$und1__O());
      continue _findLimit
    } else {
      sortedList = $as_sc_Seq(x1.splitAt__I__T2(halflistIdx).$$und2__O());
      continue _findLimit
    }
  }
});
$c_Lpoggle_LettersUtil$.prototype.distributionAcc__sc_Seq__T2 = (function(distribution) {
  $m_sc_Seq$();
  $m_sci_Seq$();
  var this$3 = new $c_scm_ListBuffer().init___();
  return $as_T2(distribution.foldLeft__O__F2__O(new $c_T2().init___O__O(0.0, this$3.toList__sci_List()), new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function($this) {
    return (function(x0$1$2, x1$1$2) {
      var x0$1 = $as_T2(x0$1$2);
      var x1$1 = $as_Lpoggle_LettersUtil$ItemFreq(x1$1$2);
      if ((x0$1 !== null)) {
        var l = $as_sc_Seq(x0$1.$$und2__O());
        $m_sc_Seq$();
        $m_sci_Seq$();
        var this$6 = new $c_scm_ListBuffer().init___();
        var x$2 = this$6.toList__sci_List();
        if (((l === null) ? (x$2 === null) : l.equals__O__Z(x$2))) {
          return new $c_T2().init___O__O(x1$1.frequency$1, $m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([x1$1])))
        }
      };
      var currentAccum = (x1$1.frequency$1 + $uD(x0$1.$$und1__O()));
      var jsx$2 = $as_sc_SeqLike(x0$1.$$und2__O());
      var jsx$1 = new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D(x1$1.item$1, currentAccum);
      var this$7 = $m_sc_Seq$();
      return new $c_T2().init___O__O(currentAccum, jsx$2.$$colon$plus__O__scg_CanBuildFrom__O(jsx$1, this$7.ReusableCBFInstance$2))
    })
  })(this))))
});
var $d_Lpoggle_LettersUtil$ = new $TypeData().initClass({
  Lpoggle_LettersUtil$: 0
}, false, "poggle.LettersUtil$", {
  Lpoggle_LettersUtil$: 1,
  O: 1
});
$c_Lpoggle_LettersUtil$.prototype.$classData = $d_Lpoggle_LettersUtil$;
var $n_Lpoggle_LettersUtil$ = (void 0);
function $m_Lpoggle_LettersUtil$() {
  if ((!$n_Lpoggle_LettersUtil$)) {
    $n_Lpoggle_LettersUtil$ = new $c_Lpoggle_LettersUtil$().init___()
  };
  return $n_Lpoggle_LettersUtil$
}
/** @constructor */
function $c_Lscoggle_Scoggle$() {
  $c_O.call(this)
}
$c_Lscoggle_Scoggle$.prototype = new $h_O();
$c_Lscoggle_Scoggle$.prototype.constructor = $c_Lscoggle_Scoggle$;
/** @constructor */
function $h_Lscoggle_Scoggle$() {
  /*<skip>*/
}
$h_Lscoggle_Scoggle$.prototype = $c_Lscoggle_Scoggle$.prototype;
$c_Lscoggle_Scoggle$.prototype.init___ = (function() {
  return this
});
$c_Lscoggle_Scoggle$.prototype.addParNodes__Lorg_scalajs_dom_raw_Node__sc_Seq__I__V = (function(gridContainer, letras, dim) {
  var jsx$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, gridContainer$1) {
    return (function(letra$2) {
      var letra = $as_T(letra$2);
      var parNode = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("span");
      var textNode = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createTextNode(letra);
      parNode.appendChild(textNode);
      parNode.classList.add("letter");
      return gridContainer$1.appendChild(parNode)
    })
  })(this, gridContainer));
  var this$1 = $m_sc_Seq$();
  letras.map__F1__scg_CanBuildFrom__O(jsx$1, this$1.ReusableCBFInstance$2)
});
$c_Lscoggle_Scoggle$.prototype.main__AT__V = (function(args) {
  var play = new $c_Lpoggle_Preparation$Game().init___Llanguage_Language__I($m_Llanguage_Spanish$(), 5);
  var board = play.shakeTheBox__sc_Seq();
  ...
  var jsx$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(x$1$2) {
      return $objectToString(x$1$2)
    })
  })(this));
  var this$1 = $m_sc_Seq$();
  this.appendPar__Lorg_scalajs_dom_raw_Node__sc_Seq__I__V(jsx$2, $as_sc_Seq(board.map__F1__scg_CanBuildFrom__O(jsx$1, this$1.ReusableCBFInstance$2)), 5)
});
$c_Lscoggle_Scoggle$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__sc_Seq__I__V = (function(targetNode, letters, dim) {
  var gridContainer = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("container");
  gridContainer.classList.add("grid");
  targetNode.appendChild(gridContainer);
  this.addParNodes__Lorg_scalajs_dom_raw_Node__sc_Seq__I__V(gridContainer, letters, dim)
});
var $d_Lscoggle_Scoggle$ = new $TypeData().initClass({
  Lscoggle_Scoggle$: 0
}, false, "scoggle.Scoggle$", {
  Lscoggle_Scoggle$: 1,
  O: 1
});
$c_Lscoggle_Scoggle$.prototype.$classData = $d_Lscoggle_Scoggle$;
var $n_Lscoggle_Scoggle$ = (void 0);
function $m_Lscoggle_Scoggle$() {
  if ((!$n_Lscoggle_Scoggle$)) {
    $n_Lscoggle_Scoggle$ = new $c_Lscoggle_Scoggle$().init___()
  };
  return $n_Lscoggle_Scoggle$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
/** @constructor */
function $c_Llanguage_Spanish$() {
  $c_O.call(this);
  this.name$1 = null;
  this.welcomeMessage$1 = null;
  this.distribution$1 = null
}
$c_Llanguage_Spanish$.prototype = new $h_O();
$c_Llanguage_Spanish$.prototype.constructor = $c_Llanguage_Spanish$;
/** @constructor */
function $h_Llanguage_Spanish$() {
  /*<skip>*/
}
$h_Llanguage_Spanish$.prototype = $c_Llanguage_Spanish$.prototype;
$c_Llanguage_Spanish$.prototype.init___ = (function() {
  $n_Llanguage_Spanish$ = this;
  this.name$1 = "spanish";
  this.welcomeMessage$1 = "\u00a1Bienvenido! Est\u00e1s jugando Poggle en espa\u00f1ol.";
  this.distribution$1 = $as_sc_Seq($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("A", 12.53), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("B", 1.42), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("C", 4.68), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("D", 5.86), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("E", 13.68), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("F", 0.69), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("G", 1.01), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("H", 0.7), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("I", 6.25), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("J", 0.44), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("K", 0.02), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("L", 4.97), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("M", 3.15), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("N", 6.71), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("\u00d1", 0.31), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("O", 8.68), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("P", 2.51), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("Qu", 0.88), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("R", 6.87), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("S", 7.98), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("T", 4.63), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("U", 3.93), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("V", 0.9), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("W", 0.01), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("X", 0.22), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("Y", 0.9), new $c_Lpoggle_LettersUtil$ItemFreq().init___O__D("Z", 0.52)])));
  return this
});
function $is_Llanguage_Spanish$(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Llanguage_Spanish$)))
}
function $as_Llanguage_Spanish$(obj) {
  return (($is_Llanguage_Spanish$(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "language.Spanish$"))
}
function $isArrayOf_Llanguage_Spanish$(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Llanguage_Spanish$)))
}
function $asArrayOf_Llanguage_Spanish$(obj, depth) {
  return (($isArrayOf_Llanguage_Spanish$(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Llanguage.Spanish$;", depth))
}
var $d_Llanguage_Spanish$ = new $TypeData().initClass({
  Llanguage_Spanish$: 0
}, false, "language.Spanish$", {
  Llanguage_Spanish$: 1,
  O: 1,
  Llanguage_Language: 1
});
$c_Llanguage_Spanish$.prototype.$classData = $d_Llanguage_Spanish$;
var $n_Llanguage_Spanish$ = (void 0);
function $m_Llanguage_Spanish$() {
  if ((!$n_Llanguage_Spanish$)) {
    $n_Llanguage_Spanish$ = new $c_Llanguage_Spanish$().init___()
  };
  return $n_Llanguage_Spanish$
}
/** @constructor */
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Lpoggle_LettersUtil$ItemFreq() {
  $c_O.call(this);
  this.item$1 = null;
  this.frequency$1 = 0.0;
  this.swap$1 = null
}
$c_Lpoggle_LettersUtil$ItemFreq.prototype = new $h_O();
$c_Lpoggle_LettersUtil$ItemFreq.prototype.constructor = $c_Lpoggle_LettersUtil$ItemFreq;
/** @constructor */
function $h_Lpoggle_LettersUtil$ItemFreq() {
  /*<skip>*/
}
$h_Lpoggle_LettersUtil$ItemFreq.prototype = $c_Lpoggle_LettersUtil$ItemFreq.prototype;
$c_Lpoggle_LettersUtil$ItemFreq.prototype.productPrefix__T = (function() {
  return "ItemFreq"
});
$c_Lpoggle_LettersUtil$ItemFreq.prototype.productArity__I = (function() {
  return 2
});
$c_Lpoggle_LettersUtil$ItemFreq.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lpoggle_LettersUtil$ItemFreq(x$1)) {
    var ItemFreq$1 = $as_Lpoggle_LettersUtil$ItemFreq(x$1);
    return ($m_sr_BoxesRunTime$().equals__O__O__Z(this.item$1, ItemFreq$1.item$1) && (this.frequency$1 === ItemFreq$1.frequency$1))
  } else {
    return false
  }
});
$c_Lpoggle_LettersUtil$ItemFreq.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.item$1;
      break
...
$c_Lpoggle_LettersUtil$ItemFreq.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lpoggle_LettersUtil$ItemFreq.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.item$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().doubleHash__D__I(this.frequency$1));
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 2)
});
$c_Lpoggle_LettersUtil$ItemFreq.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lpoggle_LettersUtil$ItemFreq.prototype.init___O__D = (function(item, frequency) {
  this.item$1 = item;
  this.frequency$1 = frequency;
  this.swap$1 = new $c_T2().init___O__O(frequency, item);
  return this
});
function $is_Lpoggle_LettersUtil$ItemFreq(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lpoggle_LettersUtil$ItemFreq)))
}
function $as_Lpoggle_LettersUtil$ItemFreq(obj) {
  return (($is_Lpoggle_LettersUtil$ItemFreq(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "poggle.LettersUtil$ItemFreq"))
}
function $isArrayOf_Lpoggle_LettersUtil$ItemFreq(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lpoggle_LettersUtil$ItemFreq)))
}
function $asArrayOf_Lpoggle_LettersUtil$ItemFreq(obj, depth) {
  return (($isArrayOf_Lpoggle_LettersUtil$ItemFreq(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lpoggle.LettersUtil$ItemFreq;", depth))
}
var $d_Lpoggle_LettersUtil$ItemFreq = new $TypeData().initClass({
  Lpoggle_LettersUtil$ItemFreq: 0
}, false, "poggle.LettersUtil$ItemFreq", {
  Lpoggle_LettersUtil$ItemFreq: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lpoggle_LettersUtil$ItemFreq.prototype.$classData = $d_Lpoggle_LettersUtil$ItemFreq;
/** @constructor */
function $c_Lpoggle_Preparation$Die() {
  $c_O.call(this);
  this.facesSymbols$1 = null;
  this.sides$1 = 0
}
$c_Lpoggle_Preparation$Die.prototype = new $h_O();
$c_Lpoggle_Preparation$Die.prototype.constructor = $c_Lpoggle_Preparation$Die;
/** @constructor */
function $h_Lpoggle_Preparation$Die() {
  /*<skip>*/
}
$h_Lpoggle_Preparation$Die.prototype = $c_Lpoggle_Preparation$Die.prototype;
$c_Lpoggle_Preparation$Die.prototype.productPrefix__T = (function() {
  return "Die"
});
$c_Lpoggle_Preparation$Die.prototype.productArity__I = (function() {
  return 2
});
$c_Lpoggle_Preparation$Die.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lpoggle_Preparation$Die(x$1)) {
    var Die$1 = $as_Lpoggle_Preparation$Die(x$1);
    var x = this.facesSymbols$1;
    var x$2 = Die$1.facesSymbols$1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      return (this.sides$1 === Die$1.sides$1)
    } else {
      return false
    }
  } else {
...
$c_Lpoggle_Preparation$Die.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.facesSymbols$1;
      break
    }
    case 1: {
      return this.sides$1;
...
$c_Lpoggle_Preparation$Die.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lpoggle_Preparation$Die.prototype.throwDie__O = (function() {
  var jsx$1 = this.facesSymbols$1;
  var this$1 = $m_s_util_Random$();
  var n = this.sides$1;
  return jsx$1.apply__I__O(this$1.self$1.nextInt__I__I(n))
});
$c_Lpoggle_Preparation$Die.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.facesSymbols$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.sides$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 2)
});
$c_Lpoggle_Preparation$Die.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lpoggle_Preparation$Die.prototype.init___sc_Seq__I = (function(facesSymbols, sides) {
  this.facesSymbols$1 = facesSymbols;
  this.sides$1 = sides;
  return this
});
function $is_Lpoggle_Preparation$Die(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lpoggle_Preparation$Die)))
}
function $as_Lpoggle_Preparation$Die(obj) {
  return (($is_Lpoggle_Preparation$Die(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "poggle.Preparation$Die"))
}
function $isArrayOf_Lpoggle_Preparation$Die(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lpoggle_Preparation$Die)))
}
function $asArrayOf_Lpoggle_Preparation$Die(obj, depth) {
  return (($isArrayOf_Lpoggle_Preparation$Die(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lpoggle.Preparation$Die;", depth))
}
var $d_Lpoggle_Preparation$Die = new $TypeData().initClass({
  Lpoggle_Preparation$Die: 0
}, false, "poggle.Preparation$Die", {
  Lpoggle_Preparation$Die: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lpoggle_Preparation$Die.prototype.$classData = $d_Lpoggle_Preparation$Die;
/** @constructor */
function $c_Lpoggle_Preparation$Game() {
  $c_O.call(this);
  this.language$1 = null;
  this.dim$1 = 0;
  this.diceSides$1 = 0;
  this.boardSurface$1 = 0;
  this.dice$1 = null
}
$c_Lpoggle_Preparation$Game.prototype = new $h_O();
$c_Lpoggle_Preparation$Game.prototype.constructor = $c_Lpoggle_Preparation$Game;
/** @constructor */
function $h_Lpoggle_Preparation$Game() {
  /*<skip>*/
}
$h_Lpoggle_Preparation$Game.prototype = $c_Lpoggle_Preparation$Game.prototype;
$c_Lpoggle_Preparation$Game.prototype.productPrefix__T = (function() {
  return "Game"
});
$c_Lpoggle_Preparation$Game.prototype.productArity__I = (function() {
  return 2
});
$c_Lpoggle_Preparation$Game.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lpoggle_Preparation$Game(x$1)) {
    var Game$1 = $as_Lpoggle_Preparation$Game(x$1);
    var x = this.language$1;
    var x$2 = Game$1.language$1;
    if ((x === x$2)) {
      return (this.dim$1 === Game$1.dim$1)
    } else {
      return false
    }
  } else {
...
$c_Lpoggle_Preparation$Game.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
...
$c_Lpoggle_Preparation$Game.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lpoggle_Preparation$Game.prototype.init___Llanguage_Language__I = (function(language, dim) {
  this.language$1 = language;
  this.dim$1 = dim;
  this.diceSides$1 = 6;
  this.boardSurface$1 = $imul(dim, dim);
  var x1 = $m_Lpoggle_LettersUtil$().distributionAcc__sc_Seq__T2($m_Lpoggle_LettersUtil$().getLettersDistribution__Llanguage_Language__sc_Seq(language));
  if ((x1 === null)) {
    throw new $c_s_MatchError().init___O(x1)
  };
  var sumAccumTotal = $uD(x1.$$und1__O());
  var distSumAccum = $as_sc_Seq(x1.$$und2__O());
  var end = this.boardSurface$1;
  var isEmpty$4 = (end <= 0);
  var scala$collection$immutable$Range$$lastElement$4 = (((-1) + end) | 0);
  $m_sc_Seq$();
  $m_sci_Seq$();
  var this$6 = new $c_scm_ListBuffer().init___();
  var z = this$6.toList__sci_List();
  var elem$1 = null;
  elem$1 = z;
  if ((!isEmpty$4)) {
    var i = 0;
    while (true) {
      var arg1 = i;
      var arg1$1 = elem$1;
      var acc = $as_sc_Seq(arg1$1);
      var end$1 = this.diceSides$1;
      ...
      if ((!isEmpty$4$1)) {
        ...
        while (true) {
          var arg1$2 = i$1;
          var elem = $as_T($m_Lpoggle_LettersUtil$().distributedRandom__s_util_Random__D__sc_Seq__O(new $c_s_util_Random().init___(), sumAccumTotal, distSumAccum));
      ...
      var randomLetters = b.result__sci_Vector();
      var jsx$1 = new $c_Lpoggle_Preparation$Die().init___sc_Seq__I(randomLetters, this.diceSides$1);
      var this$14 = $m_sc_Seq$();
      elem$1 = $as_sc_Seq(acc.$$colon$plus__O__scg_CanBuildFrom__O(jsx$1, this$14.ReusableCBFInstance$2));
  ...
  this.dice$1 = $as_sc_Seq(elem$1);
  return this
});
$c_Lpoggle_Preparation$Game.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.language$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.dim$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 2)
});
$c_Lpoggle_Preparation$Game.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lpoggle_Preparation$Game.prototype.shakeTheBox__sc_Seq = (function() {
  var jsx$2 = this.dice$1;
  var jsx$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(x$3$2) {
      var x$3 = $as_Lpoggle_Preparation$Die(x$3$2);
      return x$3.throwDie__O()
    })
  })(this));
  var this$1 = $m_sc_Seq$();
  return $as_sc_Seq(jsx$2.map__F1__scg_CanBuildFrom__O(jsx$1, this$1.ReusableCBFInstance$2))
});
function $is_Lpoggle_Preparation$Game(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lpoggle_Preparation$Game)))
}
function $as_Lpoggle_Preparation$Game(obj) {
  return (($is_Lpoggle_Preparation$Game(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "poggle.Preparation$Game"))
}
function $isArrayOf_Lpoggle_Preparation$Game(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lpoggle_Preparation$Game)))
}
function $asArrayOf_Lpoggle_Preparation$Game(obj, depth) {
  return (($isArrayOf_Lpoggle_Preparation$Game(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lpoggle.Preparation$Game;", depth))
}
var $d_Lpoggle_Preparation$Game = new $TypeData().initClass({
  Lpoggle_Preparation$Game: 0
}, false, "poggle.Preparation$Game", {
  Lpoggle_Preparation$Game: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lpoggle_Preparation$Game.prototype.$classData = $d_Lpoggle_Preparation$Game;
/** @constructor */
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
$m_Lscoggle_Scoggle$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=poogle-fastopt.js.map
